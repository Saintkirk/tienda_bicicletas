...
class Bicicleta(models.Model):
    ...
    MARCA_CHOICES = [
        # Marcas globales / Alta gama / Montaña y Ruta principales
        ("TREK", "Trek"),
        ...
        # Marcas masivas, populares y de distribución en Chile / Latinoamérica
        ("OXFORD", "Oxford"),
        ("UPLAND", "Upland"),
        ("LEADER", "Leader"),
        ("PRO_MAX", "Pro Max"),
        ...
        ("ECLIPSE", "Eclipse"),
        ("FROST", "Frost"),
        # Marcas urbanas, eléctricas y de Gravel/Alternativas
        ...
        # Opción genérica final obligatoria
        ("OTRA", "Otra / Genérica"),
    ]
